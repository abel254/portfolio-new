...
const Banner = () => {
  return (
    <div
      id="banner"
      className="bg-gradient-to-br from-maintop from-10% to-mainbottom flex-1"
    >
      <div className="pr:mx-16 pr:flex items-center justify-between pr:h-full relative">
        <div className="w-full pr:w-10/12 pr:h-full z-20 flex flex-col items-center pr:items-start">
          ...
          <button
            className="bg-mainbutton px-4 py-2 text-lg pr:text-xl text-white text-bold border-0 rounded-md mt-4 pr:mt-10 hover:bg-white hover:text-mainbutton transition ease-linear duration-200 z-20"
          >
        ...
        <div className="pr:h-full flex items-center justify-center -mt-4">
          <Image
            src={banner}
            alt="banner"
            className="rounded-full animate-astronaut z-10 w-72 pr:w-full"
          />
        </div>
        <div>
          <Image
            src={mesh}
            alt="mesh"
            className="absolute bottom-0 right-0 h-52 hidden pr:block"
          />
        </div>
      </div>
    </div>
